...
[![DGA: Platforms Code](https://img.shields.io/badge/DGA%3A%20Platforms%20Code-v1.0-006a44?style=flat-square)](https://design.dga.gov.sa/)
...
> Output generated by prompting Claude: *"Build a government portal login page — Platforms Code compliant, split layout, RTL Arabic support, bilingual EN/AR"*

![Login page — skill output](showcase/preview.jpg)
